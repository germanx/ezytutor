...
pub async fn get_courses_details_db(pool: &PgPool, tutor_id: i32, course_id: i32) -> Course {
...
pub async fn post_new_course_db(pool: &PgPool, new_course: Course) -> Course {
    let course_row = sqlx::query!(
        "insert into ezy_course_c4 (tutor_id, course_id, course_name) values ($1,$2,$3) returning tutor_id, course_id, course_name, posted_time",
